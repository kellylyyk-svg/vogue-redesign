...
function initIntroPage() {
  ...
  if (sessionStorage.getItem('vogueIntroShown')) {
    const introPage = document.getElementById('introPage');
    if (introPage) {
      introPage.style.display = 'none';
      introPage.classList.add('fading'); // Ensure logic treats it as done
    }
    ...
    hasPassedIntro = true;
    goToPage(1); // Jump directly to Hero page
    return;
  }

  // Mark as shown for next time
  sessionStorage.setItem('vogueIntroShown', 'true');
...
const videoData = [
  { title: "Troya", video: "https://videos.pexels.com/video-files/5607998/5607998-uhd_2732_1440_25fps.mp4" },
  { title: "Versace Fragrance", video: "https://videos.pexels.com/video-files/2772599/2772599-hd_1920_1080_30fps.mp4" },
  { title: "Hermès Ski", video: "https://videos.pexels.com/video-files/8036224/8036224-hd_1920_1080_25fps.mp4" },
  { title: "Dior Rouge", video: "https://videos.pexels.com/video-files/4109710/4109710-hd_1920_1080_25fps.mp4" },
  { title: "Vogue The Independents", video: "https://videos.pexels.com/video-files/4255140/4255140-hd_1920_1080_30fps.mp4" },
  { title: "Louis Vuitton Cruise", video: "https://videos.pexels.com/video-files/2711867/2711867-hd_1920_1080_30fps.mp4" },
  { title: "Jacquemus", video: "https://videos.pexels.com/video-files/3205809/3205809-hd_1920_1080_25fps.mp4" },
  { title: "Vogue Pr Da Pra", video: "https://videos.pexels.com/video-files/3205934/3205934-hd_1920_1080_25fps.mp4" }
];
...
function updateVideoUI() {
  ...
  // 2. Update Carousel Images (Vertical Stack Effect)
  ...
  thumbs.forEach(thumb => {
    ...
    if (dataIndex >= 0 && dataIndex < videoData.length) {
      // Check if video container exists, if not create
      let video = thumb.querySelector('video');
      if (!video) {
        // Clear previous content if any (e.g., img)
        thumb.innerHTML = '';
      ...
      if (currentSrc !== videoData[dataIndex].video) {
        video.src = videoData[dataIndex].video;
        video.load();
        // Play only if visible (opacity > 0) to save resources
        if (opacity > 0) {
        ...
        // Ensure play state based on visibility
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Video Page Click/Hover Listeners
  const videoItems = document.querySelectorAll('.video-list-item');
  videoItems.forEach((item) => {
    // Change to 'mouseenter' for hover interaction
